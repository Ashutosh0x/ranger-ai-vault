...
- Demonstrate USDC deposit flow
- Show LP token received

## 1:15-2:00 -- Signal Engine + Attestation
[SCREEN: Dashboard -> Signals page]
- Show live signal output with feature breakdown
- Highlight liquidation heatmap feature from Coinglass
- Show model confidence scores

[SCREEN: Dashboard -> Logs page -> Attestation tab]
- Show Ed25519 signed trade transactions
...
## 2:30-3:00 -- Results + Production Roadmap
[SCREEN: Dashboard -> Backtest page]
- Show equity curve over 6-month backtest
- Show Sharpe ratio, max drawdown, win rate
- Show live hackathon period performance

"With real vault seeding, this strategy scales to $1M+ TVL
with the same risk parameters. The Kamino floor ensures
minimum 8-10% APY even in flat markets, while the AI engine
captures alpha during high-signal environments."

[SCREEN: Ranger Earn dashboard showing the vault listed]
