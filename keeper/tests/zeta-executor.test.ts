// keeper/tests/zeta-executor.test.ts

import { ZetaExecutor } from "../src/execution/zeta-executor";
import { ZetaClient } from "@zetamarkets/sdk";
import { Connection } from "@solana/web3.js";

describe("ZetaExecutor", () => {
  let executor: ZetaExecutor;

  beforeEach(() => {
    const mockConnection = {} as Connection;
    const zetaClient = new ZetaClient(mockConnection);
    executor = new ZetaExecutor(zetaClient);
  });
